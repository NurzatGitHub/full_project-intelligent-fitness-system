...
class ChatMessage(models.Model):
    """One turn of a user's conversation with the FitBot coach."""
    ...
    # Truncated content kept on the row to keep history compact even for
    # very long assistant replies (we still serve the full text via .content).
    ...
    def __str__(self):
        return f"ChatMessage<{self.user_id}, {self.role}, {self.created_at}>"